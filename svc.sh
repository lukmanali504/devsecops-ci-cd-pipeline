...
SVC_NAME="actions.runner.lukmanali504-devsecops-ci-cd-pipeline.ip-172-31-44-13.service"
SVC_NAME=${SVC_NAME// /_}
SVC_DESCRIPTION="GitHub Actions Runner (lukmanali504-devsecops-ci-cd-pipeline.ip-172-31-44-13)"
